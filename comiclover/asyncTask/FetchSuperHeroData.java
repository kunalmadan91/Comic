...
public class FetchSuperHeroData extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... voids) {
        ...
        String url = "http://gateway.marvel.com:80/v1/public/characters?" +
    ...
    public String getSuperHeroDataFromJson(String data) {
       ...
       /* MyHero hero = gson.fromJson(data, MyHero.class);


        Log.v("MyHero", "MyHero" + hero.getStatus());*/
        ...
        try {
           ...
           Cursor c =
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                // Log.v("thumbandext","thumbandext>>"+thumbnail+""+ext);
...
/*try {*/
        ...
        //using gsonto parse data
            /*JSONObject jsonObject = new JSONObject(data);

            JSONObject outputData = jsonObject.getJSONObject("data");

            //Log.v("outputData", "outputData>>>>>>" + outputData);

            JSONArray jsonArray = outputData.getJSONArray("results");

            Log.v("outputData", "outputData>>>>>>" + jsonArray);*/
